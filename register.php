			...
			<div class="wrap-login100 p-t-85 p-b-20">
				...
				<!--menampilkan pesan error-->
					...
					<span class="login100-form-avatar">
						<a href="index.html">
						<img src="images/logoSIP.jpg" alt="AVATAR">
						</a>
					</span>
					<br>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter validate password">
						<input class="input100" type="password" name="password_2">
						<span class="focus-input100" data-placeholder="Validate Password"></span>
					</div>

					<div class="container-login100-form-btn">
						<button name="reg_user" type="submit" class="login100-form-btn">
							DAFTAR
						</button>
					</div>
